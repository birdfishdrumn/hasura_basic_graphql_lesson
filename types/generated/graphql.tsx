...
export function useGetUsersIdsQuery(
  baseOptions?: Apollo.QueryHookOptions<GetUsersIdsQuery, GetUsersIdsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetUsersIdsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetUsersIdsQuery, GetUsersIdsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
